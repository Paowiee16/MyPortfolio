            ...
            <div className="flex flex-col w-full lg:flex-row">
              ...
              <div className="grid flex-grow  card  rounded-box place-items-center p-5">
                <p className=" text-justify dark:text-white">
                  ...
                  visuals, I bring a mix of creativity and technical skills to
                  the table. From coding sleek and user-friendly interfaces
                  using HTML, CSS, and JavaScript, to designing stunning logos,
